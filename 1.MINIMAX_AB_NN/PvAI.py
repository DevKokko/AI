...
def startGame(board, participating_mills, men_placed, men_remaining, made_mills_indexes):
    ...
    while True:
        print("-> Press '1' for easy mode,'2' for normal mode,  '3' for hard mode, '4' for extra hard mode..")
        option = input()
    ...
    while True:
        ...
        if not all_men_placed:  # placement phase
            if player_turn != AI_marker:
                ...
                AI_move = ABP.alphaBetaPruning(board, 6, AI_marker, alpha, beta, counter, AI_heuristic, AI_marker, participating_mills, made_mills_indexes, men_remaining, ref_coord)
            ...
            if player_turn != AI_marker:
                ...
                AI_move = ABP.alphaBetaPruning(board, 6, AI_marker, alpha, beta, 19, AI_heuristic, AI_marker, participating_mills, made_mills_indexes, men_remaining)
