...
# returns a list of all made mills' indexes for a player
def getPlayerMadeMillsIndexes(board, player_marker):
    mills_indexes = set()
    for mill_index, possible_mill in enumerate(possible_mills):
        if board[possible_mill[0]] == player_marker and (board[possible_mill[0]] == board[possible_mill[1]] == board[possible_mill[2]]):
            mills_indexes.add(mill_index)
